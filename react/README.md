...
### If a Component is a Screen or component

Then you should add what it is after the name of the component.

`SignIn.screen.jsx`

`TextField.component.translations.jsx`
...
src
 ...
 │           └── Navigation.component.translations.json
 └── use-cases
     └── users
         ├── index.js
         ├── Users.jsx
         ...
         │   │       ├── search-field
         │   │       │   ├── index.js
         │   │       │   └── SearchField.component.jsx
         │   │       ├── index.js
         │   │       ├── Search.component.jsx
         │   │       └── Search.component.translations.json
         │   └── user-details
         │       ├── index.js
         ...
         └── components
             └── user
                 ├── user-image
                 │     ├── index.js
                 │     ├── UserImage.component.jsx
                 │     └── UserImage.component.translations.json
                 ├── index.js
                 ├── User.component.jsx
                 └── User.component.translations.json
```
